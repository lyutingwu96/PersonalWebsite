...
import { HealthEar } from "./component/projects/HealthEar";
      ...
      <div className=" w-screen  relative">
        {isAnimationComplete && (
          <Routes>
            ...
            <Route path="/projects/HealthEar" element={<HealthEar />} />
            <Route path="/projects/ExiTurtle" element={<BuildInProgress />} />
