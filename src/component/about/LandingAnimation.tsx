...
export const LandingAnimation: React.FC<LandingAnimationProps> = ({
  ...
  const animationData =
    window.innerWidth > 640 ? landingAnimationData : landingAnimationData_Phone;
  return (
    <div
      className={`w-screen h-[100svh] overflow-clip flex justify-center items-center
        ${isHidden} bg-[url('/assets/denim.png')]`}
    >
      <Lottie
        style={{ width: "100vw" }}
