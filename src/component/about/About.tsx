      ...
      <div className="w-fit mx-auto my-[120px] sm:flex sm:items-center sm:h-screen sm:my-0 sm:justify-center">
        ...
        <div className="w-[80%] mx-auto sm:w-[70%] sm:max-w-[500px] mt-[60px] sm:ml-[60px] sm:mr-[30px] sm:mt-0">
          ...
          <div className="font-content text-md text-light mb-4 font-light">
            I'm a software engineer that is enthusiastic about both{" "}
            <div className="text-pink inline-block">tech</div> and{" "}
          ...
          <div className="font-content text-md text-light  font-light">
            During my free time, I dedicate myself to digital painting. I have
            been learning drawing on my own for more than 10 years. Not only did
            the self-learning experience enable me to learn new skills fast, but
            it also make me a passionate and patient person as I always try my
            best to perfect my works.
          </div>
        </div>
      </div>
    </div>
