...
export const ProjectCard: React.FC<ProjectCardProps> = ({bannerImg, hoverImg, projectTitle, projectDescription, tags, path}) => {
  return (
    <Link to={path} className="group w-[280px] sm:w-[330px] h-[350px] sm:h-[400px] border-[1px] border-green rounded-[5px] relative  duration-700 hover:border-pink  overflow-hidden">
