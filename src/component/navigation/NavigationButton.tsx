...
export const NavigationButton : React.FC<NavigationBtnProps> = ({buttonText, path,  menuVisibilityHandler} ) => {
  ...
  return (
    <NavLink to={path} onClick={()=>menuVisibilityHandler(false)} className={({isActive})=>
